    label prologo3:
        ...
        m h1_4l "El ha dicho que prefiere asistir mañana de tal manera que trae un poema."
        n "No parece tan convincente esa unión."
        s "Y... Si tal vez solo... ¿Quiere quedar bien?."
        y "Suena a-a una bonita forma de decir que no."
        n "Aparte nadie aquí tiene la conciencia suficiente como para poder elegir algo diferente a lo que este escrito en el guion."
        m "Eso es bastante válido, es por eso que lo invité al club."
        m "Ya qué, ni siquiera sé que hace aquí."
    ...
    label pieza:
        ...
        m "¡Dejame terminar de tocar!."
        "???" "Esta bien..."
        "Un momento escucho la voz de un chico, no es [player]."
        m "¿Quien eres?."
        a "Hola Soy Astora!, probablemente un tipo que solo llego aquí de casualidad."
        m "¿Astora?..."
        "Eso nunca a estado en el código, mucho menos en el juego."
        "Pero mis pensamientos se pierden mientras toco."
        "Bueno seguiré tocando mientras con rabillo de mi ojo veo a ese tipo buscando un asiento."
        "Parece que es del colegio lo se porque tiene el uniforme."
